...
<%@page import="channel.Customer.DeleteCustomerServlet"%>
<%@page import="channel.Customer.UpdateCustomerServlet"%>
			...
			<form method="post">
				<div class="row">
					...
					<div class="d-grid gap-2">
					  <a href="TimeTable.jsp"><button id="payment-button" type="button" class="btn btn-success" style="margin-top: 50px; margin-left: 140px;">
					    Time Table Details
					  </button></a>
					</div>
